...
from .views import get_personal_account_page, add_store, get_my_store, edit_store, get_store_page, \
    delete_store, get_user_data_page, get_personal_account_inactive_adds_page, delete_or_archive_selected_ads, \
    search_of_ads_in_personal_account, get_all_dialogs, create_dialog, view_message, delete_dialogs, delete_user_message
