...
class StoreForm(forms.ModelForm):
    ...
    title = forms.CharField(max_length=255, label="Название магазина",
                            widget=forms.TextInput(attrs={'class': 'input_field'}))
    slug = forms.SlugField(min_length=4, max_length=20,
                           ...
                           widget=forms.TextInput(attrs={'class': 'input_field'}))
    description = forms.CharField(label="Описание", widget=forms.Textarea(attrs={'class': 'input_field'}))
    ...
    logo_image = forms.ImageField(required=False, label="Логотип", widget=ClearableFileInput(attrs={'class': 'input_field'}))
