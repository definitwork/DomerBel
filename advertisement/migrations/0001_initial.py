    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preview_image', models.ImageField(default='default/no_image.jpg', upload_to=advertisement.utils_for_models.upload_to, verbose_name='Главная фотография')),
                ...
                ('phone_num', models.CharField(max_length=255, validators=[users.validators.validate_phone], verbose_name='Телефон')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('photo', models.ImageField(upload_to=advertisement.utils_for_models.upload_to, verbose_name='Фото')),
            ],
            options={
